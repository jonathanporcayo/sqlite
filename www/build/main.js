...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_toast__ = __webpack_require__(195);
...
var HomePage = (function () {
    ...
    HomePage.prototype.removeData = function () {
        var _this = this;
        this.sqlite.create({
            name: 'ionicdb.db',
            location: 'default'
            ...
            db.executeSql('DROP TABLE IF EXISTS testtable', {})
                ...
                _this.toast.show('deleted', '5000', 'center').subscribe(function (toast) {
    ...
    HomePage.prototype.findNames = function () {
        var _this = this;
        this.sqlite.create({
            name: 'ionicdb.db',
            location: 'default'
            ...
            db.executeSql('SELECT * FROM testtable WHERE name IS NOT null', {})
                ...
                for (var i = 0; i < res.rows.length; i++) {
                    _this.names.push(res.rows.item(i).name);
                }
                _this.names_value = '' + _this.names;
            })
                .catch(function (e) {
                console.log(e);
                _this.toast.show(e, '5000', 'center').subscribe(function (toast) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_sqlite__ = __webpack_require__(194);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/jonathan/Downloads/ionic3-sqlite-master/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/jonathan/Downloads/ionic3-sqlite-master/src/app/app.html"*/
        }),
